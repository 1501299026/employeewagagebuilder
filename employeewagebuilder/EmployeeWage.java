...
public class EmpWage
{
    ...
    public static void main(String args[])
    {
        ...
        employeeWageComputation.addCompany("Reliance", 4, 30, 100);
        employeeWageComputation.addCompany("Dmart", 5, 40, 170);
        employeeWageComputation.addCompany("Accenture", 9, 10, 70);
